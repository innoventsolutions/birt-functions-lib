...
import org.eclipse.birt.data.aggregation.impl.TotalFirst;
...
public class DecimalFirst extends TotalFirst {
	@Override
	...
	public String getDisplayName() {
		return "Decimal First"; //$NON-NLS-1$
	}

	@Override
	public String getDescription() {
		return "First of Decimal Values";
	}
