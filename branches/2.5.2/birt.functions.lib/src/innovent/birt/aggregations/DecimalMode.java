...
import org.eclipse.birt.data.aggregation.impl.TotalMode;
...
public class DecimalMode extends TotalMode {
	@Override
	...
	public String getDisplayName() {
		return "Decimal Mode"; //$NON-NLS-1$
	}

	@Override
	public String getDescription() {
		return "Mode of Decimal Values";
	}
