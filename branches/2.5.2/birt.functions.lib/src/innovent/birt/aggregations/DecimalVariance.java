...
public class DecimalVariance extends AggrFunction implements IAggrFunction {
	@Override
	public String getName() {
		return "DECIMALVARIANCE";
	}

	@Override
	public String getDisplayName() {
		return "Decimal Variance"; //$NON-NLS-1$
	}

	@Override
	public String getDescription() {
		return "Variance of Decimal Values";
	}
	...
	private static class MyAccumulator extends Accumulator {
		...
		public Object getValue() throws DataException {
			...
			return countBd.multiply(squareSum).subtract(sum.multiply(sum)).divide(
