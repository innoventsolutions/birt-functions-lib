...
public class DecimalPercentileTest {
	private Accumulator prepare() {
		final IAggrFunction fn = new DecimalQuartile();
	...
	public void testAccumulateBigDecimalZero() {
		...
		try {
			accumulator.start();
			accumulator.onRow(new Object[] { new BigDecimal(0), Double.valueOf(2) });
			accumulator.onRow(new Object[] { new BigDecimal(0), Double.valueOf(2) });
			accumulator.onRow(new Object[] { new BigDecimal(0), Double.valueOf(2) });
			accumulator.onRow(new Object[] { new BigDecimal(0), Double.valueOf(2) });
			accumulator.onRow(new Object[] { new BigDecimal(0), Double.valueOf(2) });
	...
	public void testAccumulateBigDecimal() {
		...
		try {
			accumulator.start();
			accumulator.onRow(new Object[] { new BigDecimal(1), Double.valueOf(2) });
	...
	public void testAccumulateIntegers() {
		...
		try {
			accumulator.start();
			accumulator.onRow(new Object[] { Integer.valueOf(1), Double.valueOf(2) });
			accumulator.onRow(new Object[] { Integer.valueOf(1), Double.valueOf(2) });
			accumulator.onRow(new Object[] { Integer.valueOf(2), Double.valueOf(2) });
			accumulator.onRow(new Object[] { Integer.valueOf(3), Double.valueOf(2) });
			accumulator.onRow(new Object[] { Integer.valueOf(3), Double.valueOf(2) });
			accumulator.finish();
			final var value = accumulator.getValue();
			final var expected = new BigDecimal(2);
	...
	public void testAccumulateDoubles() {
		...
		try {
			accumulator.start();
			accumulator.onRow(new Object[] { Double.valueOf(1), Double.valueOf(2) });
			accumulator.onRow(new Object[] { Double.valueOf(1), Double.valueOf(2) });
			accumulator.onRow(new Object[] { Double.valueOf(2), Double.valueOf(2) });
			accumulator.onRow(new Object[] { Double.valueOf(3), Double.valueOf(2) });
			accumulator.onRow(new Object[] { Double.valueOf(3), Double.valueOf(2) });
			accumulator.finish();
			final var value = accumulator.getValue();
